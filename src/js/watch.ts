...
$(document).ready(function() {
		var clock = new PrWatch.Clock(),
				...
				year = $('#shape305-718').find('text'),
				monthArrow = $('#group245-605'),
				dOfMonthArrow = $('#shape282-692'),
				dayArrow = $('#shape142-373'),
				day2Arrow = $('#shape248-867'),
				workHourArrow = $('#shape368-869'),
				hourArrow = $('#group330-886'),
				minuteArrow = $('#group327-880'),
				secArrow = $('#shape141-371');
